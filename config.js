...
module.exports = {
  ...
  BOT_NAME: process.env.BOT_NAME || 'ᴛᴏᴍ-ᴏꜰꜰɪᴄɪᴀʟ',
  ...
  BOT_INFO: process.env.BOT_INFO || 'ᴛᴏᴍ-ᴏꜰꜰɪᴄɪᴀʟ;ᴛᴏᴍ;8801714821271;https://i.imgur.com/6oRG106.jpeg',
  AUDIO_DATA: process.env.AUDIO_DATA || 'ᴛᴏᴍ-ᴏꜰꜰɪᴄɪᴀʟ;ᴛᴏᴍ;https://i.imgur.com/fj2WE83.jpeg',
  STICKER_DATA: process.env.STICKER_DATA || 'ᴛᴏᴍ-ᴏꜰꜰɪᴄɪᴀʟ;ᴛᴏᴍ',
  ...
  SUDO: process.env.SUDO || '8801714821271',
  DEBUG: DEBUG
};
